...
| 2026-08-15 | `<th>` headers | Header hover tooltips | Switched from native `title` to CSS `[data-tip]` system — tooltips now appear above headers instead of below. Uses existing `tip` column config. |
